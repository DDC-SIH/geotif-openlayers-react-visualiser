...
import { Search, Layers, Settings, Info, ChevronRight, Filter } from "lucide-react";
  ...
  return (
    <div className="w-screen h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        {/* Floating Sidebar */}
        <div className="absolute right-4 top-4 flex flex-col gap-2 pointer-events-auto z-50">
          {/* Icons Bar */}
          <div
            className={`bg-white  shadow-lg rounded-lg p-3 flex flex-col gap-3 ${
          ...
          >
            ...
            <Button
              size="icon"
              variant={activeSidebar === "filter" ? "default" : "ghost"}
              className="rounded-full shadow"
              onClick={() =>
                setActiveSidebar(
                  activeSidebar === "filter" ? null : "filter"
                )
              }
            >
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Slider
                      ...
                      step={0.1}
                      onValueChange={([value]) =>
                        setColormapSettings((prev) => ({ ...prev, min: value }))
                      }
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <Slider
                      ...
                      step={0.1}
                      onValueChange={([value]) =>
                        setColormapSettings((prev) => ({ ...prev, max: value }))
                      }
                    />
                    <div className="flex justify-between text-xs">
                      <span>-2</span>
        ...
        <div className="fixed left-4 top-4 pointer-events-auto z-50">
          <div className="flex items-center bg-white backdrop-blur-md rounded-full px-3 py-1.5 shadow-lg overflow-hidden">
            <div
              className={cn(
